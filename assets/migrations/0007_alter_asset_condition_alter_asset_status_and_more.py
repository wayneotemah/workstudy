...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('assets', '0006_borrowed_asset_student_id_alter_asset_condition_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='category',
            field=models.TextField(choices=[('Others', 'Others'), ('VGA Cables', 'VGA Cables'), ('VGA-HDMI Converters', ' VGA-HDMI Converters'), ('Projector', 'Projector'), ('HDMI Cables', 'HDMI Cables')], max_length=50, verbose_name='Asset category name'),
        ),
    ]
